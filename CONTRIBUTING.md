...
DiskSweep ships with 8 languages: English (source), French, German, Spanish, Japanese, Korean, Portuguese (Brazilian), and Chinese (Simplified). Native-speaker refinements via PR are welcome.
...
- **App name** "DiskSweep" is never translated
